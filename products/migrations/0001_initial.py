    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_item', to='products.product')),
                ('set_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_set', to='products.product')),
            ],
            options={
